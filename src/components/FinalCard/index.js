...
export default function OtherCard() {
  return (
    <>
<main className="font-sans antialiased text-gray-900 leading-normal tracking-wider bg-cover" style={{backgroundImage:"url('https://i.pinimg.com/originals/e9/78/b8/e978b8b11beb33e386639953c976f20a.jpg')"}}>
  ...
  <div className="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
	...
	<div id="profile" className="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
		...
		<div className="p-4 md:p-12 text-center lg:text-left">
			...
			<h1 className="text-3xl font-bold pt-8 lg:pt-0">Some Girl</h1>
			...
			<p className="pt-8 text-sm">I play multiple instruments and currently I am searching for people to create a band. Looking for someone to play drums especially. I enjoy all music genres.</p>
